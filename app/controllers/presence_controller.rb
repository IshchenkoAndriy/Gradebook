class PresenceController < ApplicationController
  ...
  def create
    ...
    if @new_presence.save
      redirect_to :back, notice: 'Presence successful saved'
    else
  ...
  def update
    ...
    if @presence.update_attributes(params[:presence])
      redirect_to :back, notice: 'Presence successful updated'
    else
  ...
  def destroy
    ...
    redirect_to :back, notice: 'Presence was successful destroyed'
  end
end
